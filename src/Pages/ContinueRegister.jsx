  ...
  return (
    <div className="continue-register-container">
      ...
      <h1 className="title">Complete Your Profile</h1>
        ...
        <label>Gender:</label>
        <select className="register-input" onChange={chgGender}>
          <option value="Female">Select a Gender</option>
        ...
        <label>Phone:</label>
        <input type="text" className="register-input" onChange={chgPhone} />
        {phoneError && <p className="error-message">{phoneError}</p>}
        <label>City:</label>
        <select className="register-input" onChange={chgCity}>
        ...
        <div className="register-buttons">
          ...
          <button className="register-btn back" onClick={btnCheckIn}>
            Back
          </button>
        </div>
      </div>
